...
/**
 * Test Design — e2e/PCRE2EmitterTest.java
 *
 * <h2>Purpose</h2>
...
public class PCRE2EmitterTest {
    ...
    static Stream<Arguments> coreLanguageFeatures() {
        return Stream.of(
    ...
    @MethodSource("coreLanguageFeatures")
    ...
    @Test
    void testAllFlagsGeneratedCorrectly() {
        /**
    ...
    @Test
    void testAllMetacharactersEscaped() {
        /**
    ...
    static Stream<Arguments> extensionFeatures() {
        return Stream.of(
    ...
    @ParameterizedTest(name = "ID: {2}")
    @MethodSource("extensionFeatures")
    ...
    static Stream<Arguments> goldenPatterns() {
        return Stream.of(
    ...
    @Test
    void testNginxAccessLogPatternRaisesOnEscapedSpace() {
        /**
        ...
        assertThrows(STRlingParseError.class, () -> compileToPcre(nginx));
        STRlingParseError error = assertThrows(STRlingParseError.class, () -> compileToPcre(nginx));
    ...
    @Test
    void testParseErrorPropagatesThroughPipeline() {
        /**
         * Tests that an invalid DSL string raises a ParseError when the full
         * compilation is attempted.
         */
        assertThrows(STRlingParseError.class, () -> compileToPcre("a(b"));
        STRlingParseError error = assertThrows(STRlingParseError.class, () -> compileToPcre("a(b"));
        assertTrue(error.getMessage().contains("Unterminated group"));
    }

    @Test
    void testLowercaseZEscapeInExtensionFeaturesRaises() {
        /**
         * Ensure a pattern containing lowercase \z raises through the pipeline
         */
        assertThrows(STRlingParseError.class, () -> compileToPcre("\\Astart\\z"));
        STRlingParseError error = assertThrows(STRlingParseError.class, () -> compileToPcre("\\Astart\\z"));
