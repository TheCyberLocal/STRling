...
public struct STRlingParseError: Error {
    ...
    /// An instructional hint explaining how to fix the error (always present)
    ...
    ///   - hint: An instructional hint explaining how to fix the error (default: generated by HintEngine)
    public init(message: String, pos: Int, text: String = "", hint: String? = nil) {
        self.message = message
        self.pos = pos
        self.text = text
        self.hint = hint ?? HintEngine.getHint(message, text: text, pos: pos)
    }
