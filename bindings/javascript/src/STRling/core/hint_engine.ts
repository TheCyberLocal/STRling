...
class HintEngine {
    ...
    private hintUnterminatedGroup(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnterminatedCharClass(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnterminatedNamedBackref(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnterminatedGroupName(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnterminatedLookahead(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnterminatedLookbehind(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnterminatedAtomicGroup(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnterminatedBraceQuant(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnexpectedToken(msg: string, text: string, pos: number): string {
    ...
    private hintUnexpectedTrailing(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintCannotQuantifyAnchor(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUndefinedBackref(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintDuplicateGroupName(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintAlternationNoLhs(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintAlternationNoRhs(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintInlineModifiers(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnterminatedHexBrace(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnterminatedUnicodeBrace(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnterminatedUnicodeProperty(msg: string, text: string, pos: number): string {
        return (
    ...
    private hintUnicodePropertyMissingBrace(msg: string, text: string, pos: number): string {
        return (
