...
// Central part: 456
const centralPart = s.group("centralPart", s.digit(3)); // Exactly 3 digits and named for later reference

// Last part: 7890
const lastPart = s.group("lastPart", s.digit(4)); // Exactly 4 digits and named for later reference
