...
static void test_category_a_positive(void **state) {
    const TestCase cases[] = {
        ...
        {"special_char_backspace_escape", 
         ...
         "[\\b]"} // PCRE2 treats \b in class as backspace
    };
