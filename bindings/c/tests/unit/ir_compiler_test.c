...
static void test_category_e_deep_alt(void **state) {
    const TestCase cases[] = {
        ...
        {"deep_alt_mixed", 
         "{\"type\": \"Group\", \"capturing\": false, \"expression\": {\"type\": \"Sequence\", \"parts\": ["
             "{\"type\": \"Alternation\", \"alternatives\": [{\"type\": \"Literal\", \"value\": \"a\"}, {\"type\": \"Literal\", \"value\": \"b\"}]},"
...
static void test_category_i_feature_detection(void **state) {
    const TestCase cases[] = {
        // 33. Named Groups
        {"feat_named_group", 
         "{\"type\": \"Group\", \"capturing\": true, \"name\": \"mygroup\", \"expression\": {\"type\": \"Literal\", \"value\": \"a\"}}", 
         "(?<mygroup>a)"},
        ...
        {"feat_unicode", 
         "{\"type\": \"CharacterClass\", \"members\": [{\"type\": \"Escape\", \"kind\": \"unicode_property\", \"property\": \"Letter\"}]}", 
         "[\\p{Letter}]"},
        ...
        {"feat_multiple", 
         "{\"type\": \"Sequence\", \"parts\": ["
             "{\"type\": \"Group\", \"atomic\": true, \"expression\": {\"type\": \"Literal\", \"value\": \"a\"}},"
             "{\"type\": \"Lookaround\", \"kind\": \"lookbehind\", \"negated\": false, \"expression\": {\"type\": \"Literal\", \"value\": \"c\"}}"
         "]}", 
         "(?>a)(?<=c)"}
    };
    run_test_batch(state, cases, sizeof(cases) / sizeof(cases[0]));
