...
Status: P17-T06 CP1 scope and contract lock
...
CP2 must freeze the exact task-start tree, all thirty semantic-copy paths,
...
resistance before any semantic copy is deleted. It must also establish exact
post-migration public extraction for all three facades and deterministic
generated Essential surfaces.

CP3 may implement only the locked bridges and facade contracts. CP4 owns live
