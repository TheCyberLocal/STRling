...
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------------: | :-------------------------------: | :-----------: | :--------------: | :--------------------: | :-------------------: | :-----: |
| C                      | [bindings/c/src/strling.c](../../bindings/c/src/strling.c)                                                                                     | [emitter_edges_test.c](../../bindings/c/tests/unit/emitter_edges_test.c), [pcre2_emitter_test.c](../../bindings/c/tests/e2e/pcre2_emitter_test.c) |         ❌          |                ❌                 |      ✅       |        ✅        |           ❌           |   ⚠️ surrogate only   |   ❌    |
...
| Rust                   | [bindings/rust/src/emitters/pcre2.rs](../../bindings/rust/src/emitters/pcre2.rs)                                                               | [e2e_tests.rs](../../bindings/rust/tests/e2e_tests.rs)                                                                                            |         ❌          |                ❌                 |      ✅       |        ✅        |           ❌           |       ⚠️ basic        |   ❌    |
...
| C++                    | bindings/cpp/src/ (no dedicated PCRE2 unit)                                                                                                    | [e2e_test.cpp](../../bindings/cpp/test/unit/e2e_test.cpp)                                                                                         |         ❌          |                ❌                 |      ⚠️       |        ⚠️        |           ❌           |       ⚠️ basic        |   ❌    |
