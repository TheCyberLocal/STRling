...
| Python                 | retired historical runner                                                                           | [frozen historical corpus](../../tooling/legacy_reference/python_corpus.json)                       |  ⚠️ docstring only  |                ❌                 |      ✅       |        ✅        | ⚠️ golden fixture only |   ⚠️ basic `\p{L}`    |   ❌    |
...
| TypeScript (reference) | retired historical runtime                                                                          | [frozen historical corpus](../../tooling/legacy_reference/corpus.json)                              | ⚠️ schema flag only | ⚠️ `deeply_nested_quantifiers` ID |      ✅       |        ✅        |           ❌           |       ⚠️ basic        |   ❌    |
