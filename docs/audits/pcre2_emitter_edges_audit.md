...
| Python                 | [frozen historical runner](../../tooling/legacy_reference/python_reference.py)                      | [frozen historical corpus](../../tooling/legacy_reference/python_corpus.json)                       |  ⚠️ docstring only  |                ❌                 |      ✅       |        ✅        | ⚠️ golden fixture only |   ⚠️ basic `\p{L}`    |   ❌    |
| Swift                  | [frozen P17-T06 historical bundle](../../tests/adapters/go-dart-swift-3.0/legacy-baseline.json)     | [frozen P17-T06 historical bundle](../../tests/adapters/go-dart-swift-3.0/legacy-baseline.json)     | ⚠️ schema flag only |                ❌                 |      ✅       |        ✅        |           ❌           |     ⚠️ `\p{...}`      |   ❌    |
| TypeScript (reference) | [frozen historical runtime](../../tooling/legacy_reference/legacy_runtime.mjs)                      | [frozen historical corpus](../../tooling/legacy_reference/corpus.json)                              | ⚠️ schema flag only | ⚠️ `deeply_nested_quantifiers` ID |      ✅       |        ✅        |           ❌           |       ⚠️ basic        |   ❌    |
...
| Go                     | [frozen P17-T06 historical bundle](../../tests/adapters/go-dart-swift-3.0/legacy-baseline.json)     | [frozen P17-T06 historical bundle](../../tests/adapters/go-dart-swift-3.0/legacy-baseline.json)     |         ❌          |                ❌                 |      ⚠️       |        ⚠️        |           ❌           |       ⚠️ basic        |   ❌    |
| Java                   | [frozen P17-T04 historical bundle](../../tests/adapters/3.0/legacy-baseline.json)                   | [frozen P17-T04 historical bundle](../../tests/adapters/3.0/legacy-baseline.json)                   |         ❌          |                ❌                 |      ✅       |        ✅        | ⚠️ golden fixture only | ⚠️ runtime validation |   ❌    |
| C#                     | [frozen P17-T05 historical bundle](../../tests/adapters/dotnet-3.0/legacy-baseline.json)            | [frozen P17-T05 historical bundle](../../tests/adapters/dotnet-3.0/legacy-baseline.json)            |         ❌          |                ❌                 |      ⚠️       |        ⚠️        |           ❌           |       ⚠️ basic        |   ❌    |
...
| Ruby                   | [frozen P17-T07 historical bundle](../../tests/adapters/dynamic-languages-3.0/legacy-baseline.json) | [frozen P17-T07 historical bundle](../../tests/adapters/dynamic-languages-3.0/legacy-baseline.json) |         ❌          |                ❌                 |      ✅       |        ✅        |           ❌           |       ⚠️ basic        |   ❌    |
| Kotlin                 | [frozen P17-T04 historical bundle](../../tests/adapters/3.0/legacy-baseline.json)                   | bindings/kotlin/src/test/kotlin/strling/                                                            |         ❌          |                ❌                 |      ⚠️       |        ⚠️        |           ❌           |       ⚠️ basic        |   ❌    |
| Lua                    | [frozen P17-T07 historical bundle](../../tests/adapters/dynamic-languages-3.0/legacy-baseline.json) | [frozen P17-T07 historical bundle](../../tests/adapters/dynamic-languages-3.0/legacy-baseline.json) |         ❌          |                ❌                 |      ⚠️       |        ⚠️        |           ❌           |       ⚠️ basic        |   ❌    |
| Perl                   | [frozen P17-T07 historical bundle](../../tests/adapters/dynamic-languages-3.0/legacy-baseline.json) | [frozen P17-T07 historical bundle](../../tests/adapters/dynamic-languages-3.0/legacy-baseline.json) |         ❌          |                ❌                 |      ⚠️       |        ⚠️        |           ❌           |       ⚠️ basic        |   ❌    |
| PHP                    | [frozen P17-T07 historical bundle](../../tests/adapters/dynamic-languages-3.0/legacy-baseline.json) | [frozen P17-T07 historical bundle](../../tests/adapters/dynamic-languages-3.0/legacy-baseline.json) |         ❌          |                ❌                 |      ⚠️       |        ⚠️        |           ❌           |       ⚠️ basic        |   ❌    |
| R                      | [frozen P17-T07 historical bundle](../../tests/adapters/dynamic-languages-3.0/legacy-baseline.json) | [frozen P17-T07 historical bundle](../../tests/adapters/dynamic-languages-3.0/legacy-baseline.json) |         ❌          |                ❌                 |      ✅       |        ✅        |           ❌           |       ⚠️ basic        |   ❌    |
| Dart                   | [frozen P17-T06 historical bundle](../../tests/adapters/go-dart-swift-3.0/legacy-baseline.json)     | [frozen P17-T06 historical bundle](../../tests/adapters/go-dart-swift-3.0/legacy-baseline.json)     |         ❌          |                ❌                 |      ⚠️       |        ⚠️        |           ❌           |       ⚠️ basic        |   ❌    |
| F#                     | [frozen P17-T05 historical bundle](../../tests/adapters/dotnet-3.0/legacy-baseline.json)            | [frozen P17-T05 historical bundle](../../tests/adapters/dotnet-3.0/legacy-baseline.json)            |         ❌          |                ❌                 |      ⚠️       |        ⚠️        |           ❌           |       ⚠️ basic        |   ❌    |
...
-   The frozen historical TypeScript corpus retains the prior combinatorial observations in [corpus.json](../../tooling/legacy_reference/corpus.json), but they test _output correctness_, not _bounded recursion_.
...
-   The only historical ReDoS-adjacent observations are preserved in the [frozen Python corpus](../../tooling/legacy_reference/python_corpus.json). These prove the **safe form compiles**; they do **not** prove the **unsafe form is detected and warned**.
