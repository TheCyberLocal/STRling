...
This document defines STRling's **high-level engineering principles** and **contribution process** for testing. It explains *why* we test the way we do and *how* testing fits into the contribution workflow.
