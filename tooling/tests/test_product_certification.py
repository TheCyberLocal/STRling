...
class ProductCertificationImplementationTests(unittest.TestCase):
    ...
    def test_full_profile_merge_is_exact_and_repeatable(self) -> None:
        ...
        coverage = cast(dict[str, Any], deterministic["coverage"])
        self.assertEqual(119, coverage["expected_result_count"])
        self.assertEqual(119, coverage["observed_result_count"])
        self.assertEqual(26, coverage["expected_structured_producer_count"])
        self.assertEqual(26, coverage["observed_structured_producer_count"])
    ...
    def test_release_profile_uses_the_same_closed_product_evidence(self) -> None:
        ...
        self.assertEqual(119, deterministic["coverage"]["observed_result_count"])
        self.assertEqual("passed", deterministic["aggregate"]["status"])
    ...
    def test_human_report_is_derived_only_from_the_machine_artifact(self) -> None:
        ...
        self.assertIn("119/119 results", report)
        self.assertIn("26/26 structured producers", report)
    ...
    def test_static_authority_check_is_structured(self) -> None:
        ...
        self.assertEqual(119, details["profile_result_count"])
        self.assertEqual(26, details["structured_producer_count"])
