...
| [`cli/`](cli/1.0/README.md)                                                        | Independently versioned command-line transport response contract, currently `1.0.0`                                   | Wrap canonical explanation, migration, and target-inspection values without changing CompileResult, Simply, or any embedded semantic/target authority.                        |
| [`interop/`](interop/1.0/README.md)                                                | Independently versioned host-neutral byte protocol plus native C and raw WebAssembly ABI contracts, currently `1.0.0` | Expose canonical compiler/profile/Simply values through stable serialized and primitive buffer boundaries without exposing Rust layout or creating adapter semantics.         |
...
spec/
    ...
    cli/              # independently versioned command-line transport contracts
    interop/          # independently versioned native and WebAssembly boundaries
