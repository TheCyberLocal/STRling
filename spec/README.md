...
| [`stdlib/`](stdlib/)                                                               | Normative guarantee vocabulary, ratified lexical-shape decisions, and the versioned canonical Essential-5 registry | Preserve audited behavior and claim boundaries; generate compatibility metadata from the registry, implement core semantics in P14-T03, and converge public surfaces in P14-T04. |
